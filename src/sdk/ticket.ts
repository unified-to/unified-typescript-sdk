...
export class Ticket extends ClientSDK {
  ...
  async createTicketingTicket(
    ...
    return unwrapAsync(ticketCreateTicketingTicket(
      this,
      request,
      options,
    ));
  ...
  async getTicketingTicket(
    ...
    return unwrapAsync(ticketGetTicketingTicket(
      this,
      request,
      options,
    ));
  ...
  async listTicketingTickets(
    ...
    return unwrapAsync(ticketListTicketingTickets(
      this,
      request,
      options,
    ));
  ...
  async patchTicketingTicket(
    ...
    return unwrapAsync(ticketPatchTicketingTicket(
      this,
      request,
      options,
    ));
  ...
  async updateTicketingTicket(
    ...
    return unwrapAsync(ticketUpdateTicketingTicket(
      this,
      request,
      options,
    ));
