...
export class Group extends ClientSDK {
    ...
    async createHrisGroup(
        ...
        return unwrapAsync(groupCreateHrisGroup(this, request, options));
    }
    ...
    async getHrisGroup(
        ...
        return unwrapAsync(groupGetHrisGroup(this, request, options));
    }
    ...
    async listHrisGroups(
        ...
        return unwrapAsync(groupListHrisGroups(this, request, options));
    }
    ...
    async patchHrisGroup(
        ...
        return unwrapAsync(groupPatchHrisGroup(this, request, options));
    }
    ...
    async updateHrisGroup(
        ...
        return unwrapAsync(groupUpdateHrisGroup(this, request, options));
    }
}
