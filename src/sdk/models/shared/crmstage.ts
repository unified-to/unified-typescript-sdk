...
/** @internal */
export const CrmStage$inboundSchema: z.ZodType<CrmStage, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const CrmStage$outboundSchema: z.ZodType<CrmStage$Outbound, z.ZodTypeDef, CrmStage> = z
    .object({
        active: z.boolean().optional(),
        createdAt: z
            .date()
