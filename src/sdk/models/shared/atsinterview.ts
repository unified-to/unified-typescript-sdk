...
/** @internal */
export const AtsInterviewStatus$inboundSchema: z.ZodNativeEnum<typeof AtsInterviewStatus> =
    z.nativeEnum(AtsInterviewStatus);

/** @internal */
export const AtsInterviewStatus$outboundSchema: z.ZodNativeEnum<typeof AtsInterviewStatus> =
...
/** @internal */
export const AtsInterview$inboundSchema: z.ZodType<AtsInterview, z.ZodTypeDef, unknown> = z
    .object({
