...
/** @internal */
export const CrmLead$inboundSchema: z.ZodType<CrmLead, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const CrmLead$outboundSchema: z.ZodType<CrmLead$Outbound, z.ZodTypeDef, CrmLead> = z
    .object({
