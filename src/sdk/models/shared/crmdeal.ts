...
/** @internal */
export const CrmDeal$inboundSchema: z.ZodType<CrmDeal, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const CrmDeal$outboundSchema: z.ZodType<CrmDeal$Outbound, z.ZodTypeDef, CrmDeal> = z
    .object({
        amount: z.number().optional(),
        closedAt: z
            .date()
