...
/** @internal */
export const KmsSpace$inboundSchema: z.ZodType<KmsSpace, z.ZodTypeDef, unknown> = z
    .object({
        created_at: z
            .string()
...
/** @internal */
export const KmsSpace$outboundSchema: z.ZodType<KmsSpace$Outbound, z.ZodTypeDef, KmsSpace> = z
    .object({
        createdAt: z
            .date()
