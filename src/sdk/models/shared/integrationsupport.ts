...
/** @internal */
export const FromWebhook$inboundSchema: z.ZodNativeEnum<typeof FromWebhook> =
...
/** @internal */
export const ListAccountId$inboundSchema: z.ZodNativeEnum<typeof ListAccountId> =
    z.nativeEnum(ListAccountId);

/** @internal */
export const ListAccountId$outboundSchema: z.ZodNativeEnum<typeof ListAccountId> =
...
/** @internal */
export const ListApplicationId$inboundSchema: z.ZodNativeEnum<typeof ListApplicationId> =
    z.nativeEnum(ListApplicationId);

/** @internal */
export const ListApplicationId$outboundSchema: z.ZodNativeEnum<typeof ListApplicationId> =
...
/** @internal */
export const ListCandidateId$inboundSchema: z.ZodNativeEnum<typeof ListCandidateId> =
    z.nativeEnum(ListCandidateId);

/** @internal */
export const ListCandidateId$outboundSchema: z.ZodNativeEnum<typeof ListCandidateId> =
...
/** @internal */
export const ListChannelId$inboundSchema: z.ZodNativeEnum<typeof ListChannelId> =
    z.nativeEnum(ListChannelId);

/** @internal */
export const ListChannelId$outboundSchema: z.ZodNativeEnum<typeof ListChannelId> =
...
/** @internal */
export const ListCollectionId$inboundSchema: z.ZodNativeEnum<typeof ListCollectionId> =
    z.nativeEnum(ListCollectionId);

/** @internal */
export const ListCollectionId$outboundSchema: z.ZodNativeEnum<typeof ListCollectionId> =
...
/** @internal */
export const ListCompanyId$inboundSchema: z.ZodNativeEnum<typeof ListCompanyId> =
    z.nativeEnum(ListCompanyId);

/** @internal */
export const ListCompanyId$outboundSchema: z.ZodNativeEnum<typeof ListCompanyId> =
...
/** @internal */
export const ListContactId$inboundSchema: z.ZodNativeEnum<typeof ListContactId> =
    z.nativeEnum(ListContactId);

/** @internal */
export const ListContactId$outboundSchema: z.ZodNativeEnum<typeof ListContactId> =
...
/** @internal */
export const ListCustomerId$inboundSchema: z.ZodNativeEnum<typeof ListCustomerId> =
    z.nativeEnum(ListCustomerId);

/** @internal */
export const ListCustomerId$outboundSchema: z.ZodNativeEnum<typeof ListCustomerId> =
...
/** @internal */
export const ListDealId$inboundSchema: z.ZodNativeEnum<typeof ListDealId> =
...
/** @internal */
export const ListInterviewId$inboundSchema: z.ZodNativeEnum<typeof ListInterviewId> =
    z.nativeEnum(ListInterviewId);

/** @internal */
export const ListInterviewId$outboundSchema: z.ZodNativeEnum<typeof ListInterviewId> =
...
/** @internal */
export const ListInvoiceId$inboundSchema: z.ZodNativeEnum<typeof ListInvoiceId> =
    z.nativeEnum(ListInvoiceId);

/** @internal */
export const ListInvoiceId$outboundSchema: z.ZodNativeEnum<typeof ListInvoiceId> =
...
/** @internal */
export const ListItemId$inboundSchema: z.ZodNativeEnum<typeof ListItemId> =
...
/** @internal */
export const ListItemVariantId$inboundSchema: z.ZodNativeEnum<typeof ListItemVariantId> =
    z.nativeEnum(ListItemVariantId);

/** @internal */
export const ListItemVariantId$outboundSchema: z.ZodNativeEnum<typeof ListItemVariantId> =
...
/** @internal */
export const ListJobId$inboundSchema: z.ZodNativeEnum<typeof ListJobId> = z.nativeEnum(ListJobId);

/** @internal */
export const ListJobId$outboundSchema: z.ZodNativeEnum<typeof ListJobId> = ListJobId$inboundSchema;
...
/** @internal */
export const ListLimit$inboundSchema: z.ZodNativeEnum<typeof ListLimit> = z.nativeEnum(ListLimit);

/** @internal */
export const ListLimit$outboundSchema: z.ZodNativeEnum<typeof ListLimit> = ListLimit$inboundSchema;
...
/** @internal */
export const ListLinkId$inboundSchema: z.ZodNativeEnum<typeof ListLinkId> =
...
/** @internal */
export const ListListId$inboundSchema: z.ZodNativeEnum<typeof ListListId> =
...
/** @internal */
export const ListLocationId$inboundSchema: z.ZodNativeEnum<typeof ListLocationId> =
    z.nativeEnum(ListLocationId);

/** @internal */
export const ListLocationId$outboundSchema: z.ZodNativeEnum<typeof ListLocationId> =
...
/** @internal */
export const ListOffset$inboundSchema: z.ZodNativeEnum<typeof ListOffset> =
...
/** @internal */
export const ListOrder$inboundSchema: z.ZodNativeEnum<typeof ListOrder> = z.nativeEnum(ListOrder);

/** @internal */
export const ListOrder$outboundSchema: z.ZodNativeEnum<typeof ListOrder> = ListOrder$inboundSchema;
...
/** @internal */
export const ListProjectId$inboundSchema: z.ZodNativeEnum<typeof ListProjectId> =
    z.nativeEnum(ListProjectId);

/** @internal */
export const ListProjectId$outboundSchema: z.ZodNativeEnum<typeof ListProjectId> =
...
/** @internal */
export const ListQuery$inboundSchema: z.ZodNativeEnum<typeof ListQuery> = z.nativeEnum(ListQuery);

/** @internal */
export const ListQuery$outboundSchema: z.ZodNativeEnum<typeof ListQuery> = ListQuery$inboundSchema;
...
/** @internal */
export const ListSortByCreatedAt$inboundSchema: z.ZodNativeEnum<typeof ListSortByCreatedAt> =
    z.nativeEnum(ListSortByCreatedAt);

/** @internal */
export const ListSortByCreatedAt$outboundSchema: z.ZodNativeEnum<typeof ListSortByCreatedAt> =
...
/** @internal */
export const ListSortByName$inboundSchema: z.ZodNativeEnum<typeof ListSortByName> =
    z.nativeEnum(ListSortByName);

/** @internal */
export const ListSortByName$outboundSchema: z.ZodNativeEnum<typeof ListSortByName> =
...
/** @internal */
export const ListSortByUpdatedAt$inboundSchema: z.ZodNativeEnum<typeof ListSortByUpdatedAt> =
    z.nativeEnum(ListSortByUpdatedAt);

/** @internal */
export const ListSortByUpdatedAt$outboundSchema: z.ZodNativeEnum<typeof ListSortByUpdatedAt> =
...
/** @internal */
export const ListSpaceId$inboundSchema: z.ZodNativeEnum<typeof ListSpaceId> =
...
/** @internal */
export const ListType$inboundSchema: z.ZodNativeEnum<typeof ListType> = z.nativeEnum(ListType);

/** @internal */
export const ListType$outboundSchema: z.ZodNativeEnum<typeof ListType> = ListType$inboundSchema;
...
/** @internal */
export const ListUpdatedGte$inboundSchema: z.ZodNativeEnum<typeof ListUpdatedGte> =
    z.nativeEnum(ListUpdatedGte);

/** @internal */
export const ListUpdatedGte$outboundSchema: z.ZodNativeEnum<typeof ListUpdatedGte> =
...
/** @internal */
export const ListUserId$inboundSchema: z.ZodNativeEnum<typeof ListUserId> =
...
/** @internal */
export const SearchEmail$inboundSchema: z.ZodNativeEnum<typeof SearchEmail> =
...
/** @internal */
export const SearchLinkedinurl$inboundSchema: z.ZodNativeEnum<typeof SearchLinkedinurl> =
    z.nativeEnum(SearchLinkedinurl);

/** @internal */
export const SearchLinkedinurl$outboundSchema: z.ZodNativeEnum<typeof SearchLinkedinurl> =
...
/** @internal */
export const SearchName$inboundSchema: z.ZodNativeEnum<typeof SearchName> =
...
/** @internal */
export const SearchTwitter$inboundSchema: z.ZodNativeEnum<typeof SearchTwitter> =
    z.nativeEnum(SearchTwitter);

/** @internal */
export const SearchTwitter$outboundSchema: z.ZodNativeEnum<typeof SearchTwitter> =
...
> = z
    .object({
        ...
        webhook_events: PropertyIntegrationSupportWebhookEvents$inboundSchema.optional(),
    })
    .transform((v) => {
        return remap$(v, {
...
> = z
    .object({
        ...
        webhookEvents: PropertyIntegrationSupportWebhookEvents$outboundSchema.optional(),
    })
    .transform((v) => {
        return remap$(v, {
