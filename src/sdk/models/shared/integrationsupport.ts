...
export const ListCarrierId = {
  SupportedRequired: "supported-required",
  Supported: "supported",
  NotSupported: "not-supported",
} as const;
export type ListCarrierId = OpenEnum<typeof ListCarrierId>;
...
export const ListContentId = {
  SupportedRequired: "supported-required",
  Supported: "supported",
  NotSupported: "not-supported",
} as const;
export type ListContentId = OpenEnum<typeof ListContentId>;
...
export const ListIoId = {
  SupportedRequired: "supported-required",
  Supported: "supported",
  NotSupported: "not-supported",
} as const;
export type ListIoId = OpenEnum<typeof ListIoId>;
...
export const ListLabelId = {
  SupportedRequired: "supported-required",
  Supported: "supported",
  NotSupported: "not-supported",
} as const;
export type ListLabelId = OpenEnum<typeof ListLabelId>;
...
export const ListOrderId = {
  SupportedRequired: "supported-required",
  Supported: "supported",
  NotSupported: "not-supported",
} as const;
export type ListOrderId = OpenEnum<typeof ListOrderId>;
...
export type ListProfileId = OpenEnum<typeof ListProfileId>;
...
export const NativeWebhookCarrierId = {
  SupportedRequired: "supported-required",
  Supported: "supported",
  NotSupported: "not-supported",
} as const;
export type NativeWebhookCarrierId = OpenEnum<typeof NativeWebhookCarrierId>;
...
export const NativeWebhookCourseId = {
  SupportedRequired: "supported-required",
  Supported: "supported",
  NotSupported: "not-supported",
} as const;
...
export type NativeWebhookMemberId = OpenEnum<typeof NativeWebhookMemberId>;

export const NativeWebhookOrderId = {
  SupportedRequired: "supported-required",
  Supported: "supported",
  NotSupported: "not-supported",
} as const;
export type NativeWebhookOrderId = OpenEnum<typeof NativeWebhookOrderId>;
...
export type NativeWebhookShipmentId = OpenEnum<typeof NativeWebhookShipmentId>;

export const NativeWebhookStudentId = {
  SupportedRequired: "supported-required",
  Supported: "supported",
  NotSupported: "not-supported",
} as const;
...
export type VirtualWebhookBenefitId = OpenEnum<typeof VirtualWebhookBenefitId>;
...
export const VirtualWebhookCarrierId = {
  SupportedRequired: "supported-required",
  Supported: "supported",
  NotSupported: "not-supported",
} as const;
export type VirtualWebhookCarrierId = OpenEnum<typeof VirtualWebhookCarrierId>;
...
export const VirtualWebhookCourseId = {
  SupportedRequired: "supported-required",
  Supported: "supported",
  NotSupported: "not-supported",
} as const;
export type VirtualWebhookCourseId = OpenEnum<typeof VirtualWebhookCourseId>;
...
export const VirtualWebhookIoId = {
  SupportedRequired: "supported-required",
  Supported: "supported",
  NotSupported: "not-supported",
} as const;
export type VirtualWebhookIoId = OpenEnum<typeof VirtualWebhookIoId>;
...
export const VirtualWebhookLabelId = {
  SupportedRequired: "supported-required",
  Supported: "supported",
  NotSupported: "not-supported",
} as const;
export type VirtualWebhookLabelId = OpenEnum<typeof VirtualWebhookLabelId>;
...
export type VirtualWebhookOrderId = OpenEnum<typeof VirtualWebhookOrderId>;
...
export const VirtualWebhookPaymentId = {
  SupportedRequired: "supported-required",
  Supported: "supported",
  NotSupported: "not-supported",
} as const;
export type VirtualWebhookPaymentId = OpenEnum<typeof VirtualWebhookPaymentId>;
...
export type VirtualWebhookProfileId = OpenEnum<typeof VirtualWebhookProfileId>;
...
export type VirtualWebhookShipmentId = OpenEnum<
  typeof VirtualWebhookShipmentId
>;
...
export const VirtualWebhookStudentId = {
  SupportedRequired: "supported-required",
  Supported: "supported",
  NotSupported: "not-supported",
} as const;
...
export type IntegrationSupport = {
  ...
  listCarrierId?: ListCarrierId | undefined;
  ...
  virtualWebhookCarrierId?: VirtualWebhookCarrierId | undefined;
  ...
  virtualWebhookIoId?: VirtualWebhookIoId | undefined;
...
/** @internal */
export const ListCarrierId$inboundSchema: z.ZodType<
  ListCarrierId,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(ListCarrierId);
...
/** @internal */
export const ListContentId$inboundSchema: z.ZodType<
  ListContentId,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(ListContentId);
...
/** @internal */
export const ListFulltext$inboundSchema: z.ZodType<
  ListFulltext,
  z.ZodTypeDef,
  unknown
...
/** @internal */
export const ListIoId$inboundSchema: z.ZodType<
  ListIoId,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(ListIoId);
...
/** @internal */
export const ListLabelId$inboundSchema: z.ZodType<
  ListLabelId,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(ListLabelId);
...
/** @internal */
export const ListOrderId$inboundSchema: z.ZodType<
  ListOrderId,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(ListOrderId);
...
export const ListProfileId$inboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(ListProfileId);
...
/** @internal */
export const NativeWebhookCarrierId$inboundSchema: z.ZodType<
  NativeWebhookCarrierId,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(NativeWebhookCarrierId);
...
/** @internal */
export const NativeWebhookCourseId$inboundSchema: z.ZodType<
...
export const NativeWebhookMemberId$inboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(NativeWebhookMemberId);

/** @internal */
export const NativeWebhookOrderId$inboundSchema: z.ZodType<
  NativeWebhookOrderId,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(NativeWebhookOrderId);
...
export const NativeWebhookShipmentId$inboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(NativeWebhookShipmentId);

/** @internal */
export const NativeWebhookStudentId$inboundSchema: z.ZodType<
...
export const VirtualWebhookBenefitId$inboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(VirtualWebhookBenefitId);
...
/** @internal */
export const VirtualWebhookCarrierId$inboundSchema: z.ZodType<
  VirtualWebhookCarrierId,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(VirtualWebhookCarrierId);
...
/** @internal */
export const VirtualWebhookCourseId$inboundSchema: z.ZodType<
  VirtualWebhookCourseId,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(VirtualWebhookCourseId);
...
/** @internal */
export const VirtualWebhookIoId$inboundSchema: z.ZodType<
  VirtualWebhookIoId,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(VirtualWebhookIoId);
...
/** @internal */
export const VirtualWebhookLabelId$inboundSchema: z.ZodType<
  VirtualWebhookLabelId,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(VirtualWebhookLabelId);
...
export const VirtualWebhookOrderId$inboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(VirtualWebhookOrderId);
...
export const VirtualWebhookPaymentId$inboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(VirtualWebhookPaymentId);
...
export const VirtualWebhookProfileId$inboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(VirtualWebhookProfileId);
...
export const VirtualWebhookShipmentId$inboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(VirtualWebhookShipmentId);
...
/** @internal */
export const VirtualWebhookStudentId$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  list_carrier_id: ListCarrierId$inboundSchema.optional(),
  ...
  list_io_id: ListIoId$inboundSchema.optional(),
  ...
  list_label_id: ListLabelId$inboundSchema.optional(),
  ...
  virtual_webhook_candidate_id: VirtualWebhookCandidateId$inboundSchema
    .optional(),
  virtual_webhook_carrier_id: VirtualWebhookCarrierId$inboundSchema.optional(),
  ...
  virtual_webhook_io_id: VirtualWebhookIoId$inboundSchema.optional(),
  ...
  return remap$(v, {
    ...
    "virtual_webhook_carrier_id": "virtualWebhookCarrierId",
    ...
    "virtual_webhook_io_id": "virtualWebhookIoId",
