...
export type PropertyIntegrationSupportWebhookEvents = {
    created?: Array<PropertyPropertyIntegrationSupportWebhookEventsCreated> | undefined;
    deleted?: Array<PropertyPropertyIntegrationSupportWebhookEventsDeleted> | undefined;
    updated?: Array<PropertyPropertyIntegrationSupportWebhookEventsUpdated> | undefined;
};
...
> = z.object({
    created: z
        .array(PropertyPropertyIntegrationSupportWebhookEventsCreated$inboundSchema)
        .optional(),
    deleted: z
        .array(PropertyPropertyIntegrationSupportWebhookEventsDeleted$inboundSchema)
        .optional(),
    updated: z
        .array(PropertyPropertyIntegrationSupportWebhookEventsUpdated$inboundSchema)
        .optional(),
});
...
> = z.object({
    created: z
        .array(PropertyPropertyIntegrationSupportWebhookEventsCreated$outboundSchema)
        .optional(),
    deleted: z
        .array(PropertyPropertyIntegrationSupportWebhookEventsDeleted$outboundSchema)
        .optional(),
    updated: z
        .array(PropertyPropertyIntegrationSupportWebhookEventsUpdated$outboundSchema)
        .optional(),
});
...
export namespace PropertyIntegrationSupportWebhookEvents$ {
    ...
    export const inboundSchema = PropertyIntegrationSupportWebhookEvents$inboundSchema;
    /** @deprecated use `PropertyIntegrationSupportWebhookEvents$outboundSchema` instead. */
    export const outboundSchema = PropertyIntegrationSupportWebhookEvents$outboundSchema;
