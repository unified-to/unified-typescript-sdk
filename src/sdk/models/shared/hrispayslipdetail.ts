...
/** @internal */
export const HrisPayslipDetailType$inboundSchema: z.ZodNativeEnum<typeof HrisPayslipDetailType> =
    z.nativeEnum(HrisPayslipDetailType);

/** @internal */
export const HrisPayslipDetailType$outboundSchema: z.ZodNativeEnum<typeof HrisPayslipDetailType> =
...
/** @internal */
export const HrisPayslipDetail$inboundSchema: z.ZodType<HrisPayslipDetail, z.ZodTypeDef, unknown> =
    z
        .object({
            amount: z.number(),
