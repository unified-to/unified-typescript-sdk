...
/** @internal */
export const AccountingContact$inboundSchema: z.ZodType<AccountingContact, z.ZodTypeDef, unknown> =
    z
        .object({
            billing_address: PropertyAccountingContactBillingAddress$inboundSchema.optional(),
            ...
            payment_methods: z.array(AccountingContactPaymentMethod$inboundSchema).optional(),
            portal_url: z.string().optional(),
            raw: z.record(z.any()).optional(),
            shipping_address: PropertyAccountingContactShippingAddress$inboundSchema.optional(),
...
export type AccountingContact$Outbound = {
    billing_address?: PropertyAccountingContactBillingAddress$Outbound | undefined;
    ...
    raw?: { [k: string]: any } | undefined;
    shipping_address?: PropertyAccountingContactShippingAddress$Outbound | undefined;
...
> = z
    .object({
        billingAddress: PropertyAccountingContactBillingAddress$outboundSchema.optional(),
        ...
        name: z.string().optional(),
        paymentMethods: z.array(AccountingContactPaymentMethod$outboundSchema).optional(),
        portalUrl: z.string().optional(),
        raw: z.record(z.any()).optional(),
        shippingAddress: PropertyAccountingContactShippingAddress$outboundSchema.optional(),
