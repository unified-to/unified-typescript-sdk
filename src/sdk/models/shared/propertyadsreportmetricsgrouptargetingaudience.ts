...
export type PropertyAdsReportMetricsGroupTargetingAudience = {
...
/** @internal */
export const PropertyAdsReportMetricsGroupTargetingAudience$inboundSchema:
  z.ZodType<
...
export function propertyAdsReportMetricsGroupTargetingAudienceFromJSON(
  jsonString: string,
): SafeParseResult<
  PropertyAdsReportMetricsGroupTargetingAudience,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      PropertyAdsReportMetricsGroupTargetingAudience$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'PropertyAdsReportMetricsGroupTargetingAudience' from JSON`,
  );
}
