...
/** @internal */
export const AtsApplicationStatus$inboundSchema: z.ZodNativeEnum<typeof AtsApplicationStatus> =
    z.nativeEnum(AtsApplicationStatus);

/** @internal */
export const AtsApplicationStatus$outboundSchema: z.ZodNativeEnum<typeof AtsApplicationStatus> =
...
/** @internal */
export const AtsApplication$inboundSchema: z.ZodType<AtsApplication, z.ZodTypeDef, unknown> = z
    .object({
