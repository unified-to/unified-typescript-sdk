...
export type PropertyAdsReportMetricsAdTargeting = {
...
/** @internal */
export const PropertyAdsReportMetricsAdTargeting$inboundSchema: z.ZodType<
...
export function propertyAdsReportMetricsAdTargetingFromJSON(
  jsonString: string,
): SafeParseResult<PropertyAdsReportMetricsAdTargeting, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      PropertyAdsReportMetricsAdTargeting$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'PropertyAdsReportMetricsAdTargeting' from JSON`,
  );
}
