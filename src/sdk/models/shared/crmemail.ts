...
/** @internal */
export const CrmEmail$inboundSchema: z.ZodType<CrmEmail, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const CrmEmail$outboundSchema: z.ZodType<CrmEmail$Outbound, z.ZodTypeDef, CrmEmail> =
    z.object({
        email: z.string().optional(),
