...
/** @internal */
export const AtsAddress$inboundSchema: z.ZodType<AtsAddress, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const AtsAddress$outboundSchema: z.ZodType<AtsAddress$Outbound, z.ZodTypeDef, AtsAddress> = z
    .object({
        address1: z.string().optional(),
        address2: z.string().optional(),
        city: z.string().optional(),
