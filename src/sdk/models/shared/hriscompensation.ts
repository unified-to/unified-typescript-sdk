...
export type HrisCompensationFrequency = ClosedEnum<typeof HrisCompensationFrequency>;
...
/** @internal */
export const HrisCompensationType$inboundSchema: z.ZodNativeEnum<typeof HrisCompensationType> =
    z.nativeEnum(HrisCompensationType);

/** @internal */
export const HrisCompensationType$outboundSchema: z.ZodNativeEnum<typeof HrisCompensationType> =
...
/** @internal */
export const HrisCompensation$inboundSchema: z.ZodType<HrisCompensation, z.ZodTypeDef, unknown> =
    z.object({
