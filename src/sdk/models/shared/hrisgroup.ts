...
/** @internal */
export const HrisGroupType$inboundSchema: z.ZodNativeEnum<typeof HrisGroupType> =
    z.nativeEnum(HrisGroupType);

/** @internal */
export const HrisGroupType$outboundSchema: z.ZodNativeEnum<typeof HrisGroupType> =
