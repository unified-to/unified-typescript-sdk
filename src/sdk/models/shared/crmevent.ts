...
/** @internal */
export const CrmEvent$inboundSchema: z.ZodType<CrmEvent, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const CrmEvent$outboundSchema: z.ZodType<CrmEvent$Outbound, z.ZodTypeDef, CrmEvent> = z
    .object({
