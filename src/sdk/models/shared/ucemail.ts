...
/** @internal */
export const UcEmailType$inboundSchema: z.ZodNativeEnum<typeof UcEmailType> =
...
/** @internal */
export const UcEmail$inboundSchema: z.ZodType<UcEmail, z.ZodTypeDef, unknown> = z.object({
    email: z.string(),
...
/** @internal */
export const UcEmail$outboundSchema: z.ZodType<UcEmail$Outbound, z.ZodTypeDef, UcEmail> = z.object({
    email: z.string(),
