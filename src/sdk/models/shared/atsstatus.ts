...
/** @internal */
export const AtsStatusStatus$inboundSchema: z.ZodNativeEnum<typeof AtsStatusStatus> =
    z.nativeEnum(AtsStatusStatus);

/** @internal */
export const AtsStatusStatus$outboundSchema: z.ZodNativeEnum<typeof AtsStatusStatus> =
...
/** @internal */
export const AtsStatus$inboundSchema: z.ZodType<AtsStatus, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const AtsStatus$outboundSchema: z.ZodType<AtsStatus$Outbound, z.ZodTypeDef, AtsStatus> = z
    .object({
        description: z.string().optional(),
        id: z.string().optional(),
