...
/** @internal */
export const Recommendation$inboundSchema: z.ZodNativeEnum<typeof Recommendation> =
    z.nativeEnum(Recommendation);

/** @internal */
export const Recommendation$outboundSchema: z.ZodNativeEnum<typeof Recommendation> =
...
/** @internal */
export const AtsScorecard$inboundSchema: z.ZodType<AtsScorecard, z.ZodTypeDef, unknown> = z
    .object({
