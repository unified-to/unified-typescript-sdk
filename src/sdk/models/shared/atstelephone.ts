...
/** @internal */
export const AtsTelephoneType$inboundSchema: z.ZodNativeEnum<typeof AtsTelephoneType> =
    z.nativeEnum(AtsTelephoneType);

/** @internal */
export const AtsTelephoneType$outboundSchema: z.ZodNativeEnum<typeof AtsTelephoneType> =
...
/** @internal */
export const AtsTelephone$inboundSchema: z.ZodType<AtsTelephone, z.ZodTypeDef, unknown> = z.object({
    telephone: z.string(),
