...
export const ListAdsReports2QueryParamFields = {
  Id: "id",
...
export type ListAdsReports2QueryParamFields = ClosedEnum<
  typeof ListAdsReports2QueryParamFields
>;

export type ListAdsReports2Request = {
  /**
   ...
   * Fields to return
   */
  fields?: Array<ListAdsReports2QueryParamFields> | undefined;
  /**
...
/** @internal */
export const ListAdsReports2QueryParamFields$outboundSchema: z.ZodNativeEnum<
  typeof ListAdsReports2QueryParamFields
> = z.nativeEnum(ListAdsReports2QueryParamFields);

/** @internal */
export type ListAdsReports2Request$Outbound = {
...
/** @internal */
export const ListAdsReports2Request$outboundSchema: z.ZodType<
  ListAdsReports2Request$Outbound,
  z.ZodTypeDef,
...
> = z.object({
  ...
  fields: z.array(ListAdsReports2QueryParamFields$outboundSchema).optional(),
...
export function listAdsReports2RequestToJSON(
  listAdsReports2Request: ListAdsReports2Request,
): string {
  return JSON.stringify(
    ListAdsReports2Request$outboundSchema.parse(listAdsReports2Request),
  );
}
