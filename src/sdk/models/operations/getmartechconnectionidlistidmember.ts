...
export class GetMartechConnectionIdListIdMemberRequest extends SpeakeasyBase {
    /**
...
export class GetMartechConnectionIdListIdMemberResponse extends SpeakeasyBase {
    /**
