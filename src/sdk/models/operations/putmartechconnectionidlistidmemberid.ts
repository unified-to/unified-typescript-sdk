...
export class PutMartechConnectionIdListIdMemberIdRequest extends SpeakeasyBase {
    /**
...
export class PutMartechConnectionIdListIdMemberIdResponse extends SpeakeasyBase {
    /**
