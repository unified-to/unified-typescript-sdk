...
export class GetMartechConnectionIdListIdMemberIdRequest extends SpeakeasyBase {
    /**
...
export class GetMartechConnectionIdListIdMemberIdResponse extends SpeakeasyBase {
    /**
