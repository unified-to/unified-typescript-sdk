...
export class ListHrisLocationsRequest extends SpeakeasyBase {
    /**
...
export class ListHrisLocationsResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.HrisLocation })
