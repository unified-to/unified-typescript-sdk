...
export class PostMartechConnectionIdListIdMemberRequest extends SpeakeasyBase {
    /**
...
export class PostMartechConnectionIdListIdMemberResponse extends SpeakeasyBase {
    /**
