...
export class ListCommerceInventoriesSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class ListCommerceInventoriesRequest extends SpeakeasyBase {
    /**
...
export class ListCommerceInventoriesResponse extends SpeakeasyBase {
    /**
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.CommerceInventory })
