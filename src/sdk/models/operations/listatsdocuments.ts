...
export class ListAtsDocumentsSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class ListAtsDocumentsRequest extends SpeakeasyBase {
    /**
...
export class ListAtsDocumentsResponse extends SpeakeasyBase {
    /**
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.AtsDocument })
