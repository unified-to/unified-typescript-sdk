...
export class GetUnifiedIntegrationLoginWorkspaceIdIntegrationTypeRequest extends SpeakeasyBase {
...
export class GetUnifiedIntegrationLoginWorkspaceIdIntegrationTypeResponse extends SpeakeasyBase {
    /**
