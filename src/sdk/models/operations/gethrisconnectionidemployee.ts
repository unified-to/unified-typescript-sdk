...
export class GetHrisConnectionIdEmployeeRequest extends SpeakeasyBase {
    /**
...
export class GetHrisConnectionIdEmployeeResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.HrisEmployee })
