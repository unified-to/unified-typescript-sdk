...
export class PutTicketingConnectionIdNoteTicketIdIdRequest extends SpeakeasyBase {
...
export class PutTicketingConnectionIdNoteTicketIdIdResponse extends SpeakeasyBase {
    /**
