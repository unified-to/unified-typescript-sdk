...
export class ListMessagingMessagesRequest extends SpeakeasyBase {
...
export class ListMessagingMessagesResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.MessagingMessage })
