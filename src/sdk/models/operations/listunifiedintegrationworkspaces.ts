...
/** @internal */
export const QueryParamCategories$inboundSchema: z.ZodNativeEnum<typeof QueryParamCategories> =
    z.nativeEnum(QueryParamCategories);

/** @internal */
export const QueryParamCategories$outboundSchema: z.ZodNativeEnum<typeof QueryParamCategories> =
...
export namespace ListUnifiedIntegrationWorkspacesRequest$ {
    ...
    export const inboundSchema = ListUnifiedIntegrationWorkspacesRequest$inboundSchema;
    /** @deprecated use `ListUnifiedIntegrationWorkspacesRequest$outboundSchema` instead. */
    export const outboundSchema = ListUnifiedIntegrationWorkspacesRequest$outboundSchema;
