...
export const UpdateMessagingMessageQueryParamFields = {
  Id: "id",
...
export type UpdateMessagingMessageQueryParamFields = ClosedEnum<
  typeof UpdateMessagingMessageQueryParamFields
>;
...
export type UpdateMessagingMessageRequest = {
   ...
   */
  fields?: Array<UpdateMessagingMessageQueryParamFields> | undefined;
  /**
   * ID of the Message
   */
  id: string;
...
/** @internal */
export const UpdateMessagingMessageQueryParamFields$outboundSchema:
  z.ZodNativeEnum<typeof UpdateMessagingMessageQueryParamFields> = z.nativeEnum(
...
> = z.object({
  ...
  fields: z.array(UpdateMessagingMessageQueryParamFields$outboundSchema)
    .optional(),
  id: z.string(),
