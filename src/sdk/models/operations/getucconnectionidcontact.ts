...
export class GetUcConnectionIdContactRequest extends SpeakeasyBase {
...
export class GetUcConnectionIdContactResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.UcContact })
