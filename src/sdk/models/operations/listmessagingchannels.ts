...
export class ListMessagingChannelsRequest extends SpeakeasyBase {
    /**
...
export class ListMessagingChannelsResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.MessagingChannel })
