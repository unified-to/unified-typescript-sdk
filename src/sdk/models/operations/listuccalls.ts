...
export class ListUcCallsSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class ListUcCallsRequest extends SpeakeasyBase {
    /**
...
export class ListUcCallsResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.UcCall })
