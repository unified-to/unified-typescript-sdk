...
export class PatchAtsConnectionIdApplicationIdRequest extends SpeakeasyBase {
    /**
...
export class PatchAtsConnectionIdApplicationIdResponse extends SpeakeasyBase {
    /**
     * Successful
     */
    @SpeakeasyMetadata()
