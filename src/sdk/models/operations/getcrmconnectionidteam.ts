...
export class GetCrmConnectionIdTeamRequest extends SpeakeasyBase {
    /**
...
export class GetCrmConnectionIdTeamResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.CrmTeam })
