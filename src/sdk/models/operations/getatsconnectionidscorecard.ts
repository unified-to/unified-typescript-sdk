...
export class GetAtsConnectionIdScorecardRequest extends SpeakeasyBase {
    /**
...
export class GetAtsConnectionIdScorecardResponse extends SpeakeasyBase {
    /**
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.AtsScorecard })
