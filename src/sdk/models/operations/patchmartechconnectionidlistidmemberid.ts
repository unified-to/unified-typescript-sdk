...
export class PatchMartechConnectionIdListIdMemberIdRequest extends SpeakeasyBase {
    /**
...
export class PatchMartechConnectionIdListIdMemberIdResponse extends SpeakeasyBase {
    /**
