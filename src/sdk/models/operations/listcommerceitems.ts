...
export class ListCommerceItemsSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class ListCommerceItemsResponse extends SpeakeasyBase {
    /**
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.CommerceItem })
