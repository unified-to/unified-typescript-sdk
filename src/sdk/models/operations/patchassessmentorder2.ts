...
export const PatchAssessmentOrder2QueryParamFields = {
  Id: "id",
...
export type PatchAssessmentOrder2QueryParamFields = ClosedEnum<
  typeof PatchAssessmentOrder2QueryParamFields
>;

export type PatchAssessmentOrder2Request = {
   ...
   * Fields to return
   */
  fields?: Array<PatchAssessmentOrder2QueryParamFields> | undefined;
  /**
   * ID of the Order
   */
  id: string;
...
/** @internal */
export const PatchAssessmentOrder2QueryParamFields$outboundSchema:
  z.ZodNativeEnum<typeof PatchAssessmentOrder2QueryParamFields> = z.nativeEnum(
    PatchAssessmentOrder2QueryParamFields,
  );

/** @internal */
export type PatchAssessmentOrder2Request$Outbound = {
...
/** @internal */
export const PatchAssessmentOrder2Request$outboundSchema: z.ZodType<
  PatchAssessmentOrder2Request$Outbound,
  z.ZodTypeDef,
  PatchAssessmentOrder2Request
> = z.object({
  assessmentOrder: shared.AssessmentOrder$outboundSchema,
  connectionId: z.string(),
  fields: z.array(PatchAssessmentOrder2QueryParamFields$outboundSchema)
    .optional(),
  id: z.string(),
...
export function patchAssessmentOrder2RequestToJSON(
  patchAssessmentOrder2Request: PatchAssessmentOrder2Request,
): string {
  return JSON.stringify(
    PatchAssessmentOrder2Request$outboundSchema.parse(
      patchAssessmentOrder2Request,
    ),
  );
}
