...
export class ListKmsSpacesRequest extends SpeakeasyBase {
    /**
...
export class ListKmsSpacesResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.KmsSpace })
