...
export const UpdateAccountingInvoiceQueryParamFields = {
  Id: "id",
...
export type UpdateAccountingInvoiceQueryParamFields = ClosedEnum<
  typeof UpdateAccountingInvoiceQueryParamFields
>;
...
export type UpdateAccountingInvoiceRequest = {
   ...
   * Fields to return
   */
  fields?: Array<UpdateAccountingInvoiceQueryParamFields> | undefined;
  /**
   * ID of the Invoice
   */
  id: string;
...
/** @internal */
export const UpdateAccountingInvoiceQueryParamFields$outboundSchema:
  z.ZodNativeEnum<typeof UpdateAccountingInvoiceQueryParamFields> = z
    .nativeEnum(UpdateAccountingInvoiceQueryParamFields);
...
> = z.object({
  ...
  fields: z.array(UpdateAccountingInvoiceQueryParamFields$outboundSchema)
    .optional(),
  id: z.string(),
