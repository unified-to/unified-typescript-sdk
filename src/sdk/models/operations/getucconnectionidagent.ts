...
export class GetUcConnectionIdAgentRequest extends SpeakeasyBase {
    /**
...
export class GetUcConnectionIdAgentResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.UcAgent })
