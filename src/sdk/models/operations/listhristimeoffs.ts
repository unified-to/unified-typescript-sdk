...
export class ListHrisTimeoffsRequest extends SpeakeasyBase {
    /**
...
export class ListHrisTimeoffsResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.HrisTimeoff })
