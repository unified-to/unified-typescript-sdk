...
export class ListPaymentPayoutsRequest extends SpeakeasyBase {
    /**
...
export class ListPaymentPayoutsResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.PaymentPayout })
