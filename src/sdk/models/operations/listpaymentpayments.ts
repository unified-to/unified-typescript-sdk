...
export class ListPaymentPaymentsRequest extends SpeakeasyBase {
    /**
...
export class ListPaymentPaymentsResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.PaymentPayment })
