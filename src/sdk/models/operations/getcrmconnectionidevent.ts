...
export class GetCrmConnectionIdEventRequest extends SpeakeasyBase {
    /**
...
export class GetCrmConnectionIdEventResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.CrmEvent })
