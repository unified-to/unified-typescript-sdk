...
export class ListPaymentLinksRequest extends SpeakeasyBase {
    /**
...
export class ListPaymentLinksResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.PaymentLink })
