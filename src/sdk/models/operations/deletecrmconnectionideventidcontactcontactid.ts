...
export class DeleteCrmConnectionIdEventIdContactContactIdRequest extends SpeakeasyBase {
    /**
...
export class DeleteCrmConnectionIdEventIdContactContactIdResponse extends SpeakeasyBase {
    /**
