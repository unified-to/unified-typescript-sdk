...
export class PatchTicketingConnectionIdNoteTicketIdIdRequest extends SpeakeasyBase {
...
export class PatchTicketingConnectionIdNoteTicketIdIdResponse extends SpeakeasyBase {
    /**
