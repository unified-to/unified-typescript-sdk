...
export class ListMartechMembersSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class ListMartechMembersRequest extends SpeakeasyBase {
    /**
...
export class ListMartechMembersResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.MarketingMember })
