...
export class ListCrmCompaniesSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class ListCrmCompaniesRequest extends SpeakeasyBase {
    /**
...
export class ListCrmCompaniesResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.CrmCompany })
