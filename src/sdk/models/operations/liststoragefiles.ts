...
export class ListStorageFilesSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({
...
export class ListStorageFilesRequest extends SpeakeasyBase {
    /**
...
export class ListStorageFilesResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.StorageFile })
