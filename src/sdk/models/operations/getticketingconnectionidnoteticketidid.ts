...
export class GetTicketingConnectionIdNoteTicketIdIdRequest extends SpeakeasyBase {
    /**
...
export class GetTicketingConnectionIdNoteTicketIdIdResponse extends SpeakeasyBase {
    /**
