...
export class ListTaskTasksRequest extends SpeakeasyBase {
    /**
...
export class ListTaskTasksResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.TaskTask })
