...
export class ListTaskProjectsRequest extends SpeakeasyBase {
    /**
...
export class ListTaskProjectsResponse extends SpeakeasyBase {
    /**
     ...
     * Successful
     */
    @SpeakeasyMetadata({ elemType: shared.TaskProject })
