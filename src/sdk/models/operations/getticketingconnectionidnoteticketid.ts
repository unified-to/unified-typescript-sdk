...
export class GetTicketingConnectionIdNoteTicketIdRequest extends SpeakeasyBase {
    /**
...
export class GetTicketingConnectionIdNoteTicketIdResponse extends SpeakeasyBase {
    /**
