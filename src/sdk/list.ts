...
export class List extends ClientSDK {
    ...
    async createMartechList(
        ...
        return unwrapAsync(listCreateMartechList(this, request, options));
    }
    ...
    async getMartechList(
        ...
        return unwrapAsync(listGetMartechList(this, request, options));
    }
    ...
    async listMartechLists(
        ...
        return unwrapAsync(listListMartechLists(this, request, options));
    }
    ...
    async patchMartechList(
        ...
        return unwrapAsync(listPatchMartechList(this, request, options));
    }
    ...
    async updateMartechList(
        ...
        return unwrapAsync(listUpdateMartechList(this, request, options));
    }
}
