...
export class Note extends ClientSDK {
  ...
  async createTicketingNote(
    ...
    return unwrapAsync(noteCreateTicketingNote(
      this,
      request,
      options,
    ));
  ...
  async getTicketingNote(
    ...
    return unwrapAsync(noteGetTicketingNote(
      this,
      request,
      options,
    ));
  ...
  async listTicketingNotes(
    ...
    return unwrapAsync(noteListTicketingNotes(
      this,
      request,
      options,
    ));
  ...
  async patchTicketingNote(
    ...
    return unwrapAsync(notePatchTicketingNote(
      this,
      request,
      options,
    ));
  ...
  async updateTicketingNote(
    ...
    return unwrapAsync(noteUpdateTicketingNote(
      this,
      request,
      options,
    ));
