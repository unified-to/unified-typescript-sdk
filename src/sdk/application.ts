...
export class Application extends ClientSDK {
  ...
  async createAtsApplication(
    ...
    return unwrapAsync(applicationCreateAtsApplication(
      this,
      request,
      options,
    ));
  ...
  async getAtsApplication(
    ...
    return unwrapAsync(applicationGetAtsApplication(
      this,
      request,
      options,
    ));
  ...
  async listAtsApplications(
    ...
    return unwrapAsync(applicationListAtsApplications(
      this,
      request,
      options,
    ));
  ...
  async patchAtsApplication(
    ...
    return unwrapAsync(applicationPatchAtsApplication(
      this,
      request,
      options,
    ));
  ...
  async updateAtsApplication(
    ...
    return unwrapAsync(applicationUpdateAtsApplication(
      this,
      request,
      options,
    ));
