...
import { taskGetTaskComment } from "../funcs/taskGetTaskComment.js";
import { taskGetTaskProject } from "../funcs/taskGetTaskProject.js";
import { taskGetTaskTask } from "../funcs/taskGetTaskTask.js";
import { taskListTaskComments } from "../funcs/taskListTaskComments.js";
...
export class Task extends ClientSDK {
  ...
  async createTaskComment(
    ...
    return unwrapAsync(taskCreateTaskComment(
      this,
      request,
      options,
    ));
  ...
  async getTaskComment(
    ...
    return unwrapAsync(taskGetTaskComment(
      this,
      request,
      options,
    ));
  ...
  async listTaskComments(
    ...
    return unwrapAsync(taskListTaskComments(
      this,
      request,
      options,
    ));
  ...
  async patchTaskComment(
    ...
    return unwrapAsync(taskPatchTaskComment(
      this,
      request,
      options,
    ));
  ...
  async removeTaskComment(
    ...
    return unwrapAsync(taskRemoveTaskComment(
      this,
      request,
      options,
    ));
  ...
  async updateTaskComment(
    ...
    return unwrapAsync(taskUpdateTaskComment(
      this,
      request,
      options,
    ));
