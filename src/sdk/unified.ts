...
export class Unified {
     ...
     * Get support info
     */
    async listUnifiedSupports(
        config?: AxiosRequestConfig
    ): Promise<operations.ListUnifiedSupportsResponse> {
        const baseURL: string = utils.templateUrl(
            this.sdkConfiguration.serverURL,
            this.sdkConfiguration.serverDefaults
        );
        const operationUrl: string = baseURL.replace(/\/$/, "") + "/unified/support";
        const client: AxiosInstance = this.sdkConfiguration.defaultClient;
        let globalSecurity = this.sdkConfiguration.security;
        if (typeof globalSecurity === "function") {
            globalSecurity = await globalSecurity();
        ...
        const res: operations.ListUnifiedSupportsResponse =
            new operations.ListUnifiedSupportsResponse({
                statusCode: httpRes.status,
                contentType: responseContentType,
                rawResponse: httpRes,
            });
