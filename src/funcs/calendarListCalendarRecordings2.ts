 ...
 * List all recordings
 */
export function calendarListCalendarRecordings2(
  client: UnifiedToCore,
  request: operations.ListCalendarRecordings2Request,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<shared.CalendarRecording>,
    | UnifiedToError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListCalendarRecordings2Request$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(shared.CalendarRecording$inboundSchema)),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
