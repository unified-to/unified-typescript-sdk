 ...
 */
export async function authGetUnifiedIntegrationAuth(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetUnifiedIntegrationAuthRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/unified/integration/auth/{workspace_id}/{integration_type}")(
        pathParams$
    );
