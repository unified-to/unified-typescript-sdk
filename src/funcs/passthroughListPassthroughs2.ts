...
export enum ListPassthroughs2AcceptEnum {
 ...
 * Passthrough GET
 */
export function passthroughListPassthroughs2(
  ...
  Result<
    operations.ListPassthroughs2Response | undefined,
    | UnifiedToError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListPassthroughs2Request$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      [204, 205],
      operations.ListPassthroughs2Response$inboundSchema.optional(),
      { hdrs: true },
    ),
    M.nil(304, operations.ListPassthroughs2Response$inboundSchema.optional(), {
      hdrs: true,
    }),
    M.fail("4XX"),
    M.fail("5XX"),
