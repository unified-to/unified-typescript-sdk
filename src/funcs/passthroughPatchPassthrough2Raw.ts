...
export enum PatchPassthrough2RawAcceptEnum {
 ...
 * Passthrough PUT
 */
export function passthroughPatchPassthrough2Raw(
  ...
  Result<
    operations.PatchPassthrough2RawResponse | undefined,
    | UnifiedToError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PatchPassthrough2RawRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      [204, 205],
      operations.PatchPassthrough2RawResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
    M.nil(
      304,
