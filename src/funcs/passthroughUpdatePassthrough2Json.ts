...
export enum UpdatePassthrough2JsonAcceptEnum {
 ...
 * Passthrough PUT
 */
export function passthroughUpdatePassthrough2Json(
  ...
  Result<
    operations.UpdatePassthrough2JsonResponse | undefined,
    | UnifiedToError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdatePassthrough2JsonRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      [204, 205],
      operations.UpdatePassthrough2JsonResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
    M.nil(
      304,
