...
export enum CreatePassthrough2JsonAcceptEnum {
 ...
 * Passthrough POST
 */
export function passthroughCreatePassthrough2Json(
  ...
  Result<
    operations.CreatePassthrough2JsonResponse | undefined,
    | UnifiedToError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreatePassthrough2JsonRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      [204, 205],
      operations.CreatePassthrough2JsonResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
    M.nil(
      304,
