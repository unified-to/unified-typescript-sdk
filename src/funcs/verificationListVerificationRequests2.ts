 ...
 * List all requests
 */
export function verificationListVerificationRequests2(
  client: UnifiedToCore,
  request: operations.ListVerificationRequests2Request,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<shared.VerificationRequest>,
    | UnifiedToError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListVerificationRequests2Request$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(shared.VerificationRequest$inboundSchema)),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
