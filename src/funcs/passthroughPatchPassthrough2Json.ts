...
export enum PatchPassthrough2JsonAcceptEnum {
 ...
 * Passthrough PUT
 */
export function passthroughPatchPassthrough2Json(
  ...
  Result<
    operations.PatchPassthrough2JsonResponse | undefined,
    | UnifiedToError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PatchPassthrough2JsonRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      [204, 205],
      operations.PatchPassthrough2JsonResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
    M.nil(
      304,
