 ...
 */
export function accountingListAccountingProfitlosses2(
  client: UnifiedToCore,
  request: operations.ListAccountingProfitlosses2Request,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<shared.AccountingProfitloss>,
    | UnifiedToError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAccountingProfitlosses2Request$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(shared.AccountingProfitloss$inboundSchema)),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
