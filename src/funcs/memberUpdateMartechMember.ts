 ...
 * Update a member
 */
export async function memberUpdateMartechMember(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.UpdateMartechMemberRequest$outboundSchema.parse(value$),
  ...
  const body$ = encodeJSON$("body", payload$.MarketingMember, {
    explode: true,
  });
