...
export enum CreatePassthrough2RawAcceptEnum {
 ...
 * Passthrough POST
 */
export function passthroughCreatePassthrough2Raw(
  ...
  Result<
    operations.CreatePassthrough2RawResponse | undefined,
    | UnifiedToError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreatePassthrough2RawRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      [204, 205],
      operations.CreatePassthrough2RawResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
    M.nil(
      304,
