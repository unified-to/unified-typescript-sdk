 ...
 * Create an order
 */
export function orderCreateAssessmentOrder(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateAssessmentOrderRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/assessment/{connection_id}/order")(pathParams);
