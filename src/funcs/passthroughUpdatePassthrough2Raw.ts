...
export enum UpdatePassthrough2RawAcceptEnum {
 ...
 * Passthrough PUT
 */
export function passthroughUpdatePassthrough2Raw(
  ...
  Result<
    operations.UpdatePassthrough2RawResponse | undefined,
    | UnifiedToError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdatePassthrough2RawRequest$outboundSchema.parse(value),
  ...
  >(
    M.nil(
      [204, 205],
      operations.UpdatePassthrough2RawResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
    M.nil(
      304,
