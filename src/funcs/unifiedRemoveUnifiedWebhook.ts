 ...
 */
export async function unifiedRemoveUnifiedWebhook(
  client: UnifiedToCore,
  request: operations.RemoveUnifiedWebhookRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.RemoveUnifiedWebhookResponse | undefined,
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RemoveUnifiedWebhookRequest$outboundSchema.parse(value),
