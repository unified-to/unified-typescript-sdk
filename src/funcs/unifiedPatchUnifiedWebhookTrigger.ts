 ...
 * Trigger webhook
 */
export async function unifiedPatchUnifiedWebhookTrigger(
  client: UnifiedToCore,
  request: operations.PatchUnifiedWebhookTriggerRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.PatchUnifiedWebhookTriggerResponse | undefined,
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PatchUnifiedWebhookTriggerRequest$outboundSchema.parse(value),
