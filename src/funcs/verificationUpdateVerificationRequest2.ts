 ...
 * Update a request
 */
export function verificationUpdateVerificationRequest2(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateVerificationRequest2Request$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, shared.VerificationRequest$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
