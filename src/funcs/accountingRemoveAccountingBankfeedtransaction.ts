 ...
 */
export function accountingRemoveAccountingBankfeedtransaction(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RemoveAccountingBankfeedtransactionRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.nil(
      200,
      operations.RemoveAccountingBankfeedtransactionResponse$inboundSchema
        .optional(),
    ),
    M.fail("4XX"),
    M.fail("5XX"),
