 ...
 */
export function accountingGetAccountingBalancesheet2(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAccountingBalancesheet2Request$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/accounting/{connection_id}/balancesheet/{id}")(
    pathParams,
  );
