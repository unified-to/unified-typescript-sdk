...
export const tool$payoutListPaymentPayouts: ToolDefinition<typeof args> = {
  name: "payout-list-payment-payouts",
  description: `List all payouts`,
  args,
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await payoutListPaymentPayouts(
      client,
      args.request,
