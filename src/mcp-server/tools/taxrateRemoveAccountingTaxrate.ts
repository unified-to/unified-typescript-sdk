...
export const tool$taxrateRemoveAccountingTaxrate: ToolDefinition<typeof args> =
  {
    name: "taxrate-remove-accounting-taxrate",
    description: `Remove a taxrate`,
    args,
    tool: async (client, args, ctx) => {
      const [result, apiCall] = await taxrateRemoveAccountingTaxrate(
        client,
        args.request,
