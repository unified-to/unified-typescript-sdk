...
export const tool$ticketRemoveTicketingTicket: ToolDefinition<typeof args> = {
  name: "ticket-remove-ticketing-ticket",
  description: `Remove a ticket`,
  args,
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await ticketRemoveTicketingTicket(
      client,
      args.request,
