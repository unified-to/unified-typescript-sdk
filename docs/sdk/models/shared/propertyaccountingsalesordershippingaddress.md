...
```typescript
import { PropertyAccountingSalesorderShippingAddress } from "@unified-api/typescript-sdk/sdk/models/shared";

let value: PropertyAccountingSalesorderShippingAddress = {};
```
