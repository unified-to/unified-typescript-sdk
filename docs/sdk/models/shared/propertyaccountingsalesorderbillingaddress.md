...
```typescript
import { PropertyAccountingSalesorderBillingAddress } from "@unified-api/typescript-sdk/sdk/models/shared";

let value: PropertyAccountingSalesorderBillingAddress = {};
```
