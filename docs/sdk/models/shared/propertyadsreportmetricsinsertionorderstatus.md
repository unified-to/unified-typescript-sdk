...
```typescript
import { PropertyAdsReportMetricsInsertionorderStatus } from "@unified-api/typescript-sdk/sdk/models/shared";

let value: PropertyAdsReportMetricsInsertionorderStatus =
