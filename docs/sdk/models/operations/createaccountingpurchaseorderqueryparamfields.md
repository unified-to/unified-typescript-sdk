...
```typescript
import { CreateAccountingPurchaseorderQueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: CreateAccountingPurchaseorderQueryParamFields = "created_at";
```
