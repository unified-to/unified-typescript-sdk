...
```typescript
import { PatchAtsCandidate2QueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: PatchAtsCandidate2QueryParamFields = "created_at";
```
