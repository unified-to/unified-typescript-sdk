...
```typescript
import { UpdateHrisDevice2QueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: UpdateHrisDevice2QueryParamFields = "has_antivirus";
```
