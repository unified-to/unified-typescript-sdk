...
```typescript
import { ListAccountingCreditmemoes2QueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: ListAccountingCreditmemoes2QueryParamFields = "url";
```
