...
```typescript
import { GetCommerceItemvariant2QueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: GetCommerceItemvariant2QueryParamFields = "is_featured";
```
