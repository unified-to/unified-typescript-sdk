...
```typescript
import { PatchMessagingMessage2QueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: PatchMessagingMessage2QueryParamFields = "created_at";
```
