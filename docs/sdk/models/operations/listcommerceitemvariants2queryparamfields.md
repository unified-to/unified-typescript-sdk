...
```typescript
import { ListCommerceItemvariants2QueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: ListCommerceItemvariants2QueryParamFields = "raw";
```
