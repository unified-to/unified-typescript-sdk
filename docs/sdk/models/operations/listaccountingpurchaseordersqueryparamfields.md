...
```typescript
import { ListAccountingPurchaseordersQueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: ListAccountingPurchaseordersQueryParamFields = "shipping_address";
```
