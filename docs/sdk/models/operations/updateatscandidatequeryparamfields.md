...
```typescript
import { UpdateAtsCandidateQueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: UpdateAtsCandidateQueryParamFields = "telephones";
```
