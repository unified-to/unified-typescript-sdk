...
```typescript
import { PatchAtsScorecardQueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: PatchAtsScorecardQueryParamFields = "recommendation";
```
