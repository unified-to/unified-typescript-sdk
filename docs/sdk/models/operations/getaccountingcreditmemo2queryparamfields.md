...
```typescript
import { GetAccountingCreditmemo2QueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: GetAccountingCreditmemo2QueryParamFields = "paid_at";
```
