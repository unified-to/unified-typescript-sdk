...
```typescript
import { ListMessagingChannelsQueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: ListMessagingChannelsQueryParamFields = "parent_id";
```
