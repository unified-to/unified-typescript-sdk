...
```typescript
import { GetMessagingMessageQueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: GetMessagingMessageQueryParamFields = "parent_id";
```
