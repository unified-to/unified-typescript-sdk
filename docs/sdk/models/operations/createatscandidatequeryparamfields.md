...
```typescript
import { CreateAtsCandidateQueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: CreateAtsCandidateQueryParamFields = "company_name";
```
