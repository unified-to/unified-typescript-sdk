...
```typescript
import { CreateAccountingCreditmemo2QueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: CreateAccountingCreditmemo2QueryParamFields = "send";
```
