...
```typescript
import { PatchHrisDevice2QueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: PatchHrisDevice2QueryParamFields = "has_password_manager";
```
