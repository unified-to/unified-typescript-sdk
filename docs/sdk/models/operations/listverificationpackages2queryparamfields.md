...
```typescript
import { ListVerificationPackages2QueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: ListVerificationPackages2QueryParamFields = "needs_ip_address";
```
