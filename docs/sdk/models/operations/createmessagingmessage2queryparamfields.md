...
```typescript
import { CreateMessagingMessage2QueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: CreateMessagingMessage2QueryParamFields = "message";
```
