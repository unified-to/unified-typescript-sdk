...
```typescript
import { PatchAccountingCreditmemo2QueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: PatchAccountingCreditmemo2QueryParamFields = "refund_reason";
```
