...
```typescript
import { GetCommerceItemvariantQueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: GetCommerceItemvariantQueryParamFields = "weight";
```
