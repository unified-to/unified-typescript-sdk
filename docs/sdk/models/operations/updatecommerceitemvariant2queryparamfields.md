...
```typescript
import { UpdateCommerceItemvariant2QueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: UpdateCommerceItemvariant2QueryParamFields = "tags";
```
