...
```typescript
import { ListMessagingMessages2QueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: ListMessagingMessages2QueryParamFields = "attachments";
```
