...
```typescript
import { UpdateAccountingCreditmemo2QueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: UpdateAccountingCreditmemo2QueryParamFields = "paid_amount";
```
