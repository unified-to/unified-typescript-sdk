...
```typescript
import { PatchHrisEmployee2QueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: PatchHrisEmployee2QueryParamFields = "language_locale";
```
