...
```typescript
import { ListHrisEmployees2QueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: ListHrisEmployees2QueryParamFields = "employment_type";
```
