...
```typescript
import { UpdateAccountingJournalQueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: UpdateAccountingJournalQueryParamFields = "created_at";
```
