...
```typescript
import { ListAtsCandidates2QueryParamFields } from "@unified-api/typescript-sdk/sdk/models/operations";

let value: ListAtsCandidates2QueryParamFields = "company_name";
```
