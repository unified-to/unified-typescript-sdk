...
async function run() {
  const result = await unifiedTo.ads.createAdsAd({
    adsAd: {
      ...
      id: "9ed55afa-74b9-4871-a519-c3da75d58880",
      name: "Hermiston Group",
      status: "ARCHIVED",
      updatedAt: new Date("2024-06-05T11:08:08.405Z"),
    },
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.ads.createAdsAsset({
    adsAsset: {
      ...
      height: 400,
      id: "1b9ab7ed-89a2-4395-a90c-8802614d8950",
      mimeType: "IMAGE_PNG",
      name: "Lockman - DuBuque",
      type: "IMAGE",
      updatedAt: new Date("2022-03-15T10:44:17.300Z"),
...
async function run() {
  const result = await unifiedTo.ads.createAdsGroup({
    adsGroup: {
      ...
      endAt: new Date("2026-05-25T09:12:09.396Z"),
      id: "b61317b6-7ab9-4e3f-9709-c61e7806750f",
      languageLocale: "fr-FR",
      name: "Stark - Baumbach",
      startAt: new Date("2025-12-11T15:44:18.048Z"),
      status: "PROCESSING",
      targeting: {},
      updatedAt: new Date("2022-01-02T23:41:36.718Z"),
    },
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.ads.createAdsOrganization({
    adsOrganization: {
      ...
      currency: "USD",
      id: "099cb8eb-b793-4d9b-a197-3c45de0e9a52",
      managers: [
        {
      ...
      updatedAt: new Date("2026-02-27T21:28:39.812Z"),
    },
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.ads.getAdsAsset({
    connectionId: "<id>",
    id: "<id>",
  });
...
**Promise\<[shared.AdsPromoted](../../sdk/models/shared/adspromoted.md)\>**
...
**Promise\<[shared.AdsTarget](../../sdk/models/shared/adstarget.md)\>**
...
async function run() {
  const result = await unifiedTo.ads.listAdsAssets({
    connectionId: "<id>",
  });
...
**Promise\<[shared.AdsPromoted[]](../../models/.md)\>**
...
**Promise\<[shared.AdsTarget[]](../../models/.md)\>**
...
async function run() {
  const result = await unifiedTo.ads.patchAdsAd({
    adsAd: {
      ...
      description: "Accedo vespillo carpo dolor decet stillicidium comptus tenuis.",
      finalUrl: "https://improbable-sanity.com",
      id: "6db4b6bc-3d94-4887-bd56-5773ec3b11fe",
      name: "Hermiston Group",
      status: "ARCHIVED",
      updatedAt: new Date("2024-06-05T11:08:08.416Z"),
    },
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.ads.patchAdsGroup({
    adsGroup: {
      ...
      currency: "USD",
      effectiveStatus: "PAUSED",
      endAt: new Date("2026-05-25T09:12:09.495Z"),
      id: "2cff23f4-5691-44ce-a76d-180293dd89e8",
      languageLocale: "fr-FR",
      name: "Stark - Baumbach",
      startAt: new Date("2025-12-11T15:44:18.140Z"),
      status: "PROCESSING",
      targeting: {},
      updatedAt: new Date("2022-01-02T23:41:36.752Z"),
    },
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.ads.patchAdsOrganization({
    adsOrganization: {
      ...
      createdAt: new Date("2020-07-23T21:47:11.440Z"),
      currency: "USD",
      id: "caa97a43-09af-43dd-9023-2e624534016f",
      managers: [
        {
          id: "e4fd87df-9f8b-4fa0-a77b-b7d18669e350",
          name: "Parker, Leannon and Gibson",
      ...
      status: "PROCESSING",
      timezone: "Europe/Chisinau",
      updatedAt: new Date("2026-02-27T21:28:39.820Z"),
    },
    connectionId: "<id>",
    id: "<id>",
  });
