...
async function run() {
  const result = await unifiedTo.project.createTaskProject2({
    taskProject: {},
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.project.getTaskProject2({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.project.listTaskProjects2({
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.project.patchTaskProject2({
    taskProject: {},
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.project.removeTaskProject2({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.project.updateTaskProject2({
    taskProject: {},
    connectionId: "<id>",
    id: "<id>",
  });
