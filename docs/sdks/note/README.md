...
async function run() {
  const result = await unifiedTo.note.getTicketingNote({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.note.listTicketingNotes({
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.note.removeTicketingNote({
    connectionId: "<id>",
    id: "<id>",
  });
