...
async function run() {
  const result = await unifiedTo.kms.createKmsComment({
    kmsComment: {
      ...
      id: "400a3093-af50-4586-9085-84a3ef2549c0",
      type: "PAGE",
      updatedAt: new Date("2023-11-16T14:31:47.327Z"),
    },
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.kms.createKmsPage({
    kmsPage: {
      ...
      hasChildren: true,
      id: "fb77d94a-0ee9-47f0-95d4-b6cbfee29326",
      isActive: true,
      metadata: [],
      title: "even minister extract",
      type: "HTML",
      updatedAt: new Date("2025-09-11T12:22:06.290Z"),
...
async function run() {
  const result = await unifiedTo.kms.createKmsSpace({
    kmsSpace: {
      ...
      description: "Acer.",
      id: "f9e891a9-8477-4a4e-8a2e-b34029e82df9",
      isActive: false,
      name: "into nor afore",
      updatedAt: new Date("2025-12-04T08:27:50.196Z"),
    },
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.kms.patchKmsComment({
    kmsComment: {
      ...
      contentType: "HTML",
      createdAt: new Date("2022-08-26T14:40:49.732Z"),
      id: "1be7f034-c2b2-439d-97e2-54d0919e1793",
      type: "PAGE",
      updatedAt: new Date("2023-11-16T14:31:47.329Z"),
    },
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.kms.patchKmsPage({
    kmsPage: {
      ...
      downloadUrl: "https://agitated-validity.info",
      hasChildren: true,
      id: "ae6f0bd0-4378-4098-8186-3b48fcdc4538",
      isActive: true,
      metadata: [],
      title: "even minister extract",
      type: "HTML",
      updatedAt: new Date("2025-09-11T12:22:06.307Z"),
      webUrl: "https://another-petticoat.info",
    },
    connectionId: "<id>",
    id: "<id>",
...
async function run() {
  const result = await unifiedTo.kms.patchKmsSpace({
    kmsSpace: {
      createdAt: new Date("2022-10-31T00:56:54.246Z"),
      description: "Acer.",
      id: "04cb40a5-961d-46b8-9c06-6f9104594627",
      isActive: false,
      name: "into nor afore",
      updatedAt: new Date("2025-12-04T08:27:50.203Z"),
    },
    connectionId: "<id>",
    id: "<id>",
  });
