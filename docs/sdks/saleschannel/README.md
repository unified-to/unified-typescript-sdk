...
async function run() {
  const result = await unifiedTo.saleschannel.getCommerceSaleschannel({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.saleschannel.listCommerceSaleschannels({
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.saleschannel.removeCommerceSaleschannel({
    connectionId: "<id>",
    id: "<id>",
  });
