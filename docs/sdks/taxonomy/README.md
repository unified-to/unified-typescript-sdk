...
async function run() {
  const result = await unifiedTo.taxonomy.getHrisTaxonomy({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.taxonomy.listCrmTaxonomies({
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.taxonomy.listHrisTaxonomies({
    connectionId: "<id>",
  });
