...
**Promise\<[shared.DatastoreRecord](../../sdk/models/shared/datastorerecord.md)\>**
...
async function run() {
  const result = await unifiedTo.record.getDatastoreRecord({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.record.listDatastoreRecords({
    connectionId: "<id>",
  });
...
**Promise\<[shared.DatastoreRecord[]](../../models/.md)\>**
...
async function run() {
  const result = await unifiedTo.record.removeDatastoreRecord({
    connectionId: "<id>",
    id: "<id>",
  });
