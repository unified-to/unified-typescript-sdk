...
async function run() {
  const result = await unifiedTo.journal.createAccountingJournal({
    accountingJournal: {
      ...
      id: "32fdd628-0005-4fb8-b955-782d60d87d5d",
      postedAt: new Date("2023-10-19T13:27:37.944Z"),
      reference: "ullam",
      source: "crustulum",
      taxAmount: 78672,
      updatedAt: new Date("2022-01-01T17:03:17.376Z"),
    },
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.journal.getAccountingJournal({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.journal.listAccountingJournals({
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.journal.patchAccountingJournal({
    accountingJournal: {
      ...
      currency: "FKP",
      description: "Calco constans adipisci.",
      id: "634ba8dc-5d9f-494b-8b6f-d8d4b5a02ac1",
      postedAt: new Date("2023-10-19T13:27:37.954Z"),
      reference: "ullam",
      source: "crustulum",
      taxAmount: 78672,
      updatedAt: new Date("2022-01-01T17:03:17.381Z"),
    },
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.journal.removeAccountingJournal({
    connectionId: "<id>",
    id: "<id>",
  });
