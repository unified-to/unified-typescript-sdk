...
async function run() {
  const result = await unifiedTo.database.createDatastoreDatabase({
    datastoreDatabase: {
      ...
      id: "b4cb0ac6-70b8-481f-8a68-6c452d6d5a7a",
      isActive: true,
      name: "Rau - O'Reilly",
      password: "iYLhYwOHm0NLDvI",
      region: "France",
      updatedAt: new Date("2023-06-12T14:58:55.163Z"),
...
**Promise\<[shared.DatastoreDatabase](../../sdk/models/shared/datastoredatabase.md)\>**
...
async function run() {
  const result = await unifiedTo.database.getDatastoreDatabase({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.database.listDatastoreDatabases({
    connectionId: "<id>",
  });
...
**Promise\<[shared.DatastoreDatabase[]](../../models/.md)\>**
...
async function run() {
  const result = await unifiedTo.database.patchDatastoreDatabase({
    datastoreDatabase: {
      createdAt: new Date("2019-03-05T14:31:00.223Z"),
      description: "Substantia tantillus coniuratio repellat coerceo amet vito vorago.",
      id: "ae264d96-977f-4819-a681-f8b0397afb41",
      isActive: true,
      name: "Rau - O'Reilly",
      password: "iYLhYwOHm0NLDvI",
      region: "France",
      updatedAt: new Date("2023-06-12T14:58:55.166Z"),
      webUrl: "https://optimal-signature.name",
    },
    connectionId: "<id>",
    id: "<id>",
...
async function run() {
  const result = await unifiedTo.database.removeDatastoreDatabase({
    connectionId: "<id>",
    id: "<id>",
  });
