...
async function run() {
  const result = await unifiedTo.invoice.createAccountingInvoice({
    accountingInvoice: {
      attachments: [
        {
          ...
          id: "e5f4dcd0-7260-45da-9366-2fd94a8b7d33",
      ...
      extendedNotes: [],
      id: "176e91ae-79b9-4385-affc-467ba85c7ecf",
      invoiceNumber: "vinco",
      lineitems: [],
      metadata: [],
      ...
      payments: [],
      postedAt: new Date("2026-03-27T17:01:55.630Z"),
      ...
      totalAmount: 0,
      type: "CREDITMEMO",
      updatedAt: new Date("2023-02-06T08:09:08.833Z"),
  ...
  const result = await unifiedTo.invoice.patchAccountingInvoice({
    accountingInvoice: {
      attachments: [
        {
          downloadUrl: "https://glossy-markup.net/",
          id: "f3cbad8d-a33a-4dfb-aaa0-04968d2952bb",
          mimeType: "benevolentia",
          name: "vespillo",
        },
      ],
      ...
      dueAt: new Date("2022-11-27T21:25:37.363Z"),
      extendedNotes: [],
      id: "7e878c6b-cfa1-42c6-a10b-34416464f581",
      invoiceNumber: "vinco",
      lineitems: [],
      metadata: [],
      notes: "Auctus comburo clarus ubi.",
      ...
      paymentCollectionMethod: "send_invoice",
      payments: [],
      postedAt: new Date("2026-03-27T17:01:55.678Z"),
      reference: "adinventitias",
      send: true,
      status: "DELETED",
      taxAmount: 0,
      ...
      totalAmount: 0,
      type: "CREDITMEMO",
      updatedAt: new Date("2023-02-06T08:09:08.837Z"),
      url: "https://gifted-yarmulke.info/",
    },
    connectionId: "<id>",
    id: "<id>",
