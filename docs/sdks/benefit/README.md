...
async function run() {
  const result = await unifiedTo.benefit.getHrisBenefit({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.benefit.listHrisBenefits({
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.benefit.removeHrisBenefit({
    connectionId: "<id>",
    id: "<id>",
  });
