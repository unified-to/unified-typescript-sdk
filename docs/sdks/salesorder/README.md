...
async function run() {
  const result = await unifiedTo.salesorder.createAccountingSalesorder({
    accountingSalesorder: {
      ...
      categoryIds: [],
      closedAt: new Date("2023-08-17T04:50:11.108Z"),
      ...
      guestCount: 8,
      id: "dfda416f-d6bf-4943-8873-2af5c2e01e1c",
      lineitems: [],
      metadata: [],
      orderNumber: "988187",
      payments: [],
      postedAt: new Date("2026-01-11T19:57:54.930Z"),
      refundedAmount: 0,
      ...
      tipAmount: 34,
      totalAmount: 0,
      updatedAt: new Date("2022-02-10T19:06:49.955Z"),
    },
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.salesorder.patchAccountingSalesorder({
    accountingSalesorder: {
      ...
      categoryIds: [],
      closedAt: new Date("2023-08-17T04:50:11.128Z"),
      createdAt: new Date("2022-01-17T16:11:50.310Z"),
      currency: "ANG",
      discountAmount: 99,
      employeeUserId: "4a6b8990-c85a-499f-82d0-5011c3c95a0b",
      ...
      fulfillmentType: "TAKEOUT",
      guestCount: 8,
      id: "fd4c2cf6-0db5-4e60-aa54-b7610fe1a42d",
      lineitems: [],
      metadata: [],
      orderNumber: "988187",
      payments: [],
      postedAt: new Date("2026-01-11T19:57:54.981Z"),
      refundedAmount: 0,
      salesChannel: "Harvey, Collier and Weimann",
      serviceChargeAmount: 63,
      shippingAddress: {
