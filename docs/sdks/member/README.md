...
async function run() {
  const result = await unifiedTo.member.getMartechMember({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.member.listMartechMembers({
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.member.removeMartechMember({
    connectionId: "<id>",
    id: "<id>",
  });
