...
async function run() {
  const result = await unifiedTo.task.createTaskComment({
    taskComment: {
      ...
      hasChildren: true,
      id: "4d738459-df17-4750-9984-a0bb263c5418",
      text: "Colo ulciscor sublime tabernus.",
      updatedAt: new Date("2021-09-24T07:04:25.562Z"),
...
async function run() {
  const result = await unifiedTo.task.createTaskTask({
    taskTask: {
      attachmentIds: [],
      completedAt: new Date("2022-03-24T20:26:19.299Z"),
      createdAt: new Date("2019-01-31T08:34:55.626Z"),
      dueAt: new Date("2026-04-24T04:25:11.124Z"),
      endAt: new Date("2022-10-14T03:28:22.271Z"),
      hasChildren: true,
      id: "3ecffb8d-c85a-454d-9a6e-0164bec85000",
      metadata: [],
      ...
      priority: "LOW",
      progress: 2,
      startAt: new Date("2022-01-19T19:29:56.236Z"),
      status: "IN_PROGRESS",
      storyPoints: 0,
      tags: [
        "concido",
      ...
      type: "tubineus",
      updatedAt: new Date("2019-07-13T12:02:18.661Z"),
...
async function run() {
  const result = await unifiedTo.task.patchTaskComment({
    taskComment: {
      createdAt: new Date("2019-10-12T20:33:37.879Z"),
      hasChildren: true,
      id: "2b5f709b-fbf0-4282-9027-f975a42561c7",
      text: "Colo ulciscor sublime tabernus.",
      updatedAt: new Date("2021-09-24T07:04:25.564Z"),
      userName: "Santina Abbott",
    },
    connectionId: "<id>",
    id: "<id>",
...
async function run() {
  const result = await unifiedTo.task.patchTaskTask({
    taskTask: {
      attachmentIds: [],
      completedAt: new Date("2022-03-24T20:26:19.306Z"),
      createdAt: new Date("2019-01-31T08:34:55.626Z"),
      dueAt: new Date("2026-04-24T04:25:11.140Z"),
      endAt: new Date("2022-10-14T03:28:22.278Z"),
      hasChildren: true,
      id: "789b3cf7-9540-424f-a7cf-d90f9341c9fa",
      metadata: [],
      name: "Direct Markets Architect",
      notes: "Calcar vilicus audacia ut cultura argentum ventosus. Talis neque thymbra titulus absconditus peccatus crustulum tollo. Volva vacuus eos cedo spero. Utpote coadunatio denuncio adopto autus sono atrocitas vulnero.",
      priority: "LOW",
      progress: 2,
      startAt: new Date("2022-01-19T19:29:56.243Z"),
      status: "IN_PROGRESS",
      storyPoints: 0,
      tags: [
        "concido",
      ...
      timeSpentUnit: "SECONDS",
      type: "tubineus",
      updatedAt: new Date("2019-07-13T12:02:18.662Z"),
      url: "https://dismal-silk.net/",
    },
    connectionId: "<id>",
    id: "<id>",
