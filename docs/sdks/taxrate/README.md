...
async function run() {
  const result = await unifiedTo.taxrate.createAccountingTaxrate({
    accountingTaxrate: {
      ...
      id: "4a0f71bd-7a7f-4f0d-8870-b380e19b1296",
      isActive: false,
      metadata: [],
      name: "cogo",
      rate: 1,
      updatedAt: new Date("2025-11-05T02:01:39.683Z"),
    },
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.taxrate.patchAccountingTaxrate({
    accountingTaxrate: {
      createdAt: new Date("2020-01-04T10:37:56.894Z"),
      description: "Nemo atrox tricesimus creator aranea.",
      id: "7b398d35-b988-4b35-b9cf-4c25e808bbf2",
      isActive: false,
      metadata: [],
      name: "cogo",
      rate: 1,
      updatedAt: new Date("2025-11-05T02:01:39.694Z"),
    },
    connectionId: "<id>",
    id: "<id>",
  });
