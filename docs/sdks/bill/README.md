...
async function run() {
  const result = await unifiedTo.bill.createAccountingBill({
    accountingBill: {
      ...
      extendedNotes: [],
      id: "9749679d-fa4c-4acd-9bcd-2a59b283b849",
      lineitems: [],
      metadata: [],
      notes: "Tutamen cilicium infit.",
      paymentCollectionMethod: "charge_automatically",
      payments: [],
      postedAt: new Date("2024-04-04T21:01:51.091Z"),
      send: true,
      status: "DELETED",
      taxAmount: 0,
      term: "NET_10",
      totalAmount: 0,
      updatedAt: new Date("2025-01-29T17:00:42.695Z"),
...
async function run() {
  const result = await unifiedTo.bill.patchAccountingBill({
    accountingBill: {
      ...
      dueAt: new Date("2019-08-11T20:52:55.321Z"),
      extendedNotes: [],
      id: "a77f89c4-30b8-4e90-bb30-f3d1ed483d2f",
      lineitems: [],
      metadata: [],
      notes: "Tutamen cilicium infit.",
      paymentCollectionMethod: "charge_automatically",
      payments: [],
      postedAt: new Date("2024-04-04T21:01:51.123Z"),
      send: true,
      status: "DELETED",
      taxAmount: 0,
      term: "NET_10",
      totalAmount: 0,
      updatedAt: new Date("2025-01-29T17:00:42.734Z"),
      url: "https://coarse-interviewer.biz/",
    },
    connectionId: "<id>",
    id: "<id>",
