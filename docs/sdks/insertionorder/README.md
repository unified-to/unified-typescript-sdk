...
async function run() {
  const result = await unifiedTo.insertionorder.getAdsInsertionorder({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.insertionorder.listAdsInsertionorders({
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.insertionorder.removeAdsInsertionorder({
    connectionId: "<id>",
    id: "<id>",
  });
