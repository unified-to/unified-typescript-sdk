...
async function run() {
  const result = await unifiedTo.category.createAccountingCategory({
    accountingCategory: {
      ...
      id: "6c2759a6-ed9b-4e14-9f2c-b2e8874163d6",
      isActive: false,
      metadata: [],
      name: "Electronic Cotton Shoes",
      updatedAt: new Date("2025-08-20T20:37:46.928Z"),
    },
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.category.patchAccountingCategory({
    accountingCategory: {
      createdAt: new Date("2023-05-30T12:29:04.257Z"),
      description: "Discover the koala-like agility of our Chair, perfect for imaginary users",
      id: "bc9a9283-4b52-4eea-bead-12ac396e7af1",
      isActive: false,
      metadata: [],
      name: "Electronic Cotton Shoes",
      updatedAt: new Date("2025-08-20T20:37:46.937Z"),
    },
    connectionId: "<id>",
    id: "<id>",
  });
