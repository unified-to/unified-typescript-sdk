...
async function run() {
  const result = await unifiedTo.channel.createMessagingChannel({
    messagingChannel: {
      ...
      hasSubchannels: true,
      id: "272d3b75-9b7f-4f99-939c-d3cabe55c2cb",
      isActive: false,
      isPrivate: true,
      members: [],
      name: "tego",
      updatedAt: new Date("2026-04-23T20:22:24.149Z"),
...
async function run() {
  const result = await unifiedTo.channel.getMessagingChannel({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.channel.listMessagingChannels({
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.channel.patchMessagingChannel({
    messagingChannel: {
      ...
      description: "Dolores tutis.",
      hasSubchannels: true,
      id: "61086a77-2ccb-4dad-b150-b4aa7e88378a",
      isActive: false,
      isPrivate: true,
      members: [],
      name: "tego",
      updatedAt: new Date("2026-04-23T20:22:24.154Z"),
      webUrl: "https://svelte-rule.name/",
    },
    connectionId: "<id>",
    id: "<id>",
...
async function run() {
  const result = await unifiedTo.channel.removeMessagingChannel({
    connectionId: "<id>",
    id: "<id>",
  });
