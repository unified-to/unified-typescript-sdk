...
async function run() {
  const result = await unifiedTo.payment.createPaymentPayment({
    paymentPayment: {
      ...
      currency: "BIF",
      feeAmount: 3,
      id: "9b41de85-1e5f-4dc9-bc3e-266eccc78f08",
      ...
      totalAmount: 44219,
      type: "INVOICE",
      updatedAt: new Date("2025-05-25T05:56:38.283Z"),
    },
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.payment.createPaymentSubscription({
    paymentSubscription: {
      ...
      id: "99129709-b396-4db1-b370-0ccbc6de4a7e",
      interval: 1,
      intervalUnit: "MONTH",
      lineitems: [],
      ...
      status: "ACTIVE",
      totalAmount: 75616,
      updatedAt: new Date("2023-12-16T02:18:43.688Z"),
    },
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.payment.patchPaymentPayment({
    paymentPayment: {
      ...
      currency: "BIF",
      feeAmount: 3,
      id: "51df3208-6b0a-46e8-904f-22e52ad5df0b",
      locationId: "94f7c68e-07de-40d1-9d6f-a0896363913f",
      notes: "Tactus vilicus.",
      paymentMethod: "BANK_TRANSFER",
      reference: "auctus",
      ...
      totalAmount: 44219,
      type: "INVOICE",
      updatedAt: new Date("2025-05-25T05:56:38.304Z"),
    },
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.payment.patchPaymentSubscription({
    paymentSubscription: {
      ...
      description: "Innovative Mouse featuring important technology and Bamboo construction",
      endAt: new Date("2023-05-21T12:36:09.234Z"),
      id: "8ef923df-1203-4c05-9ea8-7c426a9d0293",
      interval: 1,
      intervalUnit: "MONTH",
      lineitems: [],
      startAt: new Date("2023-05-29T06:04:51.030Z"),
      status: "ACTIVE",
      totalAmount: 75616,
      updatedAt: new Date("2023-12-16T02:18:43.692Z"),
    },
    connectionId: "<id>",
    id: "<id>",
  });
