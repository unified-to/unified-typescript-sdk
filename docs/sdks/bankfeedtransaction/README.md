...
async function run() {
  const result = await unifiedTo.bankfeedtransaction.createAccountingBankfeedtransaction({
    accountingBankfeedtransaction: {
      ...
      id: "33a2490d-70cd-41ad-85da-bb55c461712b",
      isPending: true,
      merchantName: "Reichert, Erdman and Tillman",
      postedAt: new Date("2025-03-24T08:29:52.680Z"),
      reference: "93642593",
      transactionAt: new Date("2022-07-27T21:23:28.636Z"),
      type: "CREDIT",
      updatedAt: new Date("2022-05-23T21:33:02.303Z"),
    },
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.bankfeedtransaction.patchAccountingBankfeedtransaction({
    accountingBankfeedtransaction: {
      ...
      currency: "SRD",
      description: "payment transaction at McLaughlin - Schaden using card ending with ****8233 for DOP 574.03 in account ***9523.",
      id: "cadd2c25-d670-4c06-9563-3adf54203955",
      isPending: true,
      merchantName: "Reichert, Erdman and Tillman",
      postedAt: new Date("2025-03-24T08:29:52.686Z"),
      reference: "93642593",
      transactionAt: new Date("2022-07-27T21:23:28.636Z"),
      type: "CREDIT",
      updatedAt: new Date("2022-05-23T21:33:02.303Z"),
