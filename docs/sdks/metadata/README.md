...
async function run() {
  const result = await unifiedTo.metadata.createMetadataMetadata({
    metadataMetadata: {
      ...
      format: "PRICE",
      id: "653b5f45-259b-4ee3-ab07-e7f2fb370e1e",
      isRequired: false,
      name: "autem",
      ...
      slug: "arbustum",
      updatedAt: new Date("2025-02-26T22:55:42.828Z"),
    },
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.metadata.patchMetadataMetadata({
    metadataMetadata: {
      createdAt: new Date("2021-03-25T03:02:17.656Z"),
      format: "PRICE",
      id: "c51cce02-9add-4537-8e00-dd62ffb0c806",
      isRequired: false,
      name: "autem",
      objectType: "clubs_group",
      objects: {
      ...
      originalFormat: "advoco",
      slug: "arbustum",
      updatedAt: new Date("2025-02-26T22:55:42.835Z"),
    },
    connectionId: "<id>",
    id: "<id>",
  });
