...
async function run() {
  const result = await unifiedTo.request.createVerificationRequest2({
    verificationRequest: {},
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.request.getVerificationRequest2({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.request.listVerificationRequests2({
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.request.patchVerificationRequest2({
    verificationRequest: {},
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.request.removeVerificationRequest2({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.request.updateVerificationRequest2({
    verificationRequest: {},
    connectionId: "<id>",
    id: "<id>",
  });
