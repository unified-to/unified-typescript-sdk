...
async function run() {
  const result = await unifiedTo.commit.getRepoCommit({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.commit.listRepoCommits({
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.commit.removeRepoCommit({
    connectionId: "<id>",
    id: "<id>",
  });
