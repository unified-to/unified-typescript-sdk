...
async function run() {
  const result = await unifiedTo.scorecard.getAtsScorecard({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.scorecard.listAtsScorecards({
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.scorecard.removeAtsScorecard({
    connectionId: "<id>",
    id: "<id>",
  });
