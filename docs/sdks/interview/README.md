...
async function run() {
  const result = await unifiedTo.interview.createAtsInterview2({
    atsInterview: {},
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.interview.getAtsInterview2({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.interview.listAtsInterviews2({
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.interview.patchAtsInterview2({
    atsInterview: {},
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.interview.removeAtsInterview2({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.interview.updateAtsInterview2({
    atsInterview: {},
    connectionId: "<id>",
    id: "<id>",
  });
