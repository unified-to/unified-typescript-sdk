...
async function run() {
  const result = await unifiedTo.ticketing.createTicketingCategory({
    ticketingCategory: {
      ...
      id: "9c2ccadb-1c1a-4ae3-9fe9-debb4832f9f7",
      isActive: true,
      name: "amicitia",
      updatedAt: new Date("2025-12-16T09:44:26.337Z"),
    },
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.ticketing.createTicketingCustomer({
    ticketingCustomer: {
      ...
      id: "909217b8-c621-4e23-a0b6-84cc7d5a0168",
      ...
      updatedAt: new Date("2026-05-05T03:04:44.810Z"),
    },
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.ticketing.createTicketingTicket({
    ticketingTicket: {
      attachmentIds: [
        "a63983b7-de62-49bc-b49d-636ae1f38ebf",
        "b3242227-1a28-45c3-be6d-33a8a9d595e5",
      ],
      categoryId: "vilicus",
      ...
      dueAt: new Date("2025-07-20T20:09:35.683Z"),
      id: "60a1c111-8a61-4801-a1b5-5fb8d364c37d",
      priority: "LOW",
      source: "atavus",
      sourceRef: "9bc7ad7e-6a8d-4b88-847b-52941e1325c6",
      status: "ACTIVE",
      ...
      updatedAt: new Date("2023-05-28T15:04:40.454Z"),
...
async function run() {
  const result = await unifiedTo.ticketing.patchTicketingCategory({
    ticketingCategory: {
      createdAt: new Date("2019-10-19T22:02:51.067Z"),
      description: "Tempus umbra cibus carpo depulso torqueo. Curtus aperiam nam optio tendo. Bardus tumultus delectus arbitro amplus tollo coerceo clam comprehendo vulnero.",
      id: "e60547ed-ef33-4476-8e6a-f78cedd577de",
      isActive: true,
      name: "amicitia",
      updatedAt: new Date("2025-12-16T09:44:26.341Z"),
    },
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.ticketing.patchTicketingCustomer({
    ticketingCustomer: {
      ...
      id: "de2085f2-d0e2-4cd6-a3bd-626322e1b166",
      name: "Christian Windler",
      tags: [
        "casso",
        "peccatus",
      ...
      updatedAt: new Date("2026-05-05T03:04:44.819Z"),
    },
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.ticketing.patchTicketingTicket({
    ticketingTicket: {
      attachmentIds: [
        "245198c9-9086-41c5-9ef9-a97038f8f40f",
        "52fc12a0-6c76-4aca-b5f7-56bf88c0bb65",
      ],
      categoryId: "vilicus",
      createdAt: new Date("2021-06-25T19:19:31.279Z"),
      description: "Cura dignissimos aut clibanus vulgaris patrocinor. Laborum acies curiositas antepono coniuratio. Correptius curiositas sono censura coma. Bestia suus tot cotidie terror subito coniecto beneficium.",
      dueAt: new Date("2025-07-20T20:09:35.689Z"),
      id: "8d02de56-f1ac-4036-b937-b3c610a1a5ad",
      priority: "LOW",
      source: "atavus",
      sourceRef: "e153b7c7-56d7-4bc7-b575-c9d2e76f3234",
      status: "ACTIVE",
      subject: "Thymbra ratione minus arbitro tricesimus cetera validus.",
      tags: [
        "tamen",
      ...
      updatedAt: new Date("2023-05-28T15:04:40.456Z"),
      url: "https://yellowish-testimonial.biz",
    },
    connectionId: "<id>",
    id: "<id>",
