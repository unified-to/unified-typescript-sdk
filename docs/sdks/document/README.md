...
async function run() {
  const result = await unifiedTo.document.getHrisDocument({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.document.listHrisDocuments({
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.document.removeHrisDocument({
    connectionId: "<id>",
    id: "<id>",
  });
