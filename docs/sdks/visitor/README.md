...
async function run() {
  const result = await unifiedTo.visitor.createAnalyticsVisitor({
    analyticsVisitor: {
      createdAt: new Date("2020-04-16T20:29:48.281Z"),
      email: "Dallas_Mitchell@yahoo.com",
      firstSeenAt: new Date("2020-04-16T20:29:48.281Z"),
      id: "8c9d8456-28c8-43ed-97e0-e23c8ea300b3",
      lastSeenAt: new Date("2021-12-04T23:27:31.143Z"),
      metadata: {
        "segment": {},
      },
      name: "Desiree O'Hara",
      totalEvents: 3639,
      updatedAt: new Date("2025-06-04T01:07:03.817Z"),
    },
    connectionId: "<id>",
  });
...
**Promise\<[shared.AnalyticsVisitor](../../sdk/models/shared/analyticsvisitor.md)\>**
...
async function run() {
  const result = await unifiedTo.visitor.getAnalyticsVisitor({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.visitor.listAnalyticsVisitors({
    connectionId: "<id>",
  });
...
**Promise\<[shared.AnalyticsVisitor[]](../../models/.md)\>**
...
async function run() {
  const result = await unifiedTo.visitor.patchAnalyticsVisitor({
    analyticsVisitor: {
      createdAt: new Date("2020-04-16T20:29:48.281Z"),
      email: "Dallas_Mitchell@yahoo.com",
      firstSeenAt: new Date("2020-04-16T20:29:48.281Z"),
      id: "b947e751-6d4b-4692-88bd-fe7228f43559",
      lastSeenAt: new Date("2021-12-04T23:27:31.146Z"),
      metadata: {
        "segment": {},
      },
      name: "Desiree O'Hara",
      totalEvents: 3639,
      updatedAt: new Date("2025-06-04T01:07:03.825Z"),
    },
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.visitor.removeAnalyticsVisitor({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.visitor.updateAnalyticsVisitor({
    analyticsVisitor: {
      createdAt: new Date("2020-04-16T20:29:48.281Z"),
      email: "Dallas_Mitchell@yahoo.com",
      firstSeenAt: new Date("2020-04-16T20:29:48.281Z"),
