...
async function run() {
  const result = await unifiedTo.table.createDatastoreTable2({
    datastoreTable: {},
    connectionId: "<id>",
  });
...
**Promise\<[shared.DatastoreTable](../../sdk/models/shared/datastoretable.md)\>**
...
async function run() {
  const result = await unifiedTo.table.getDatastoreTable2({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.table.listDatastoreTables2({
    connectionId: "<id>",
  });
...
**Promise\<[shared.DatastoreTable[]](../../models/.md)\>**
...
async function run() {
  const result = await unifiedTo.table.patchDatastoreTable2({
    datastoreTable: {},
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.table.removeDatastoreTable2({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.table.updateDatastoreTable2({
    datastoreTable: {},
    connectionId: "<id>",
    id: "<id>",
  });
