...
async function run() {
  const result = await unifiedTo.pipeline.getCrmPipeline({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.pipeline.listCrmPipelines({
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.pipeline.removeCrmPipeline({
    connectionId: "<id>",
    id: "<id>",
  });
