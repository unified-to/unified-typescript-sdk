...
async function run() {
  const result = await unifiedTo.deduction.getHrisDeduction({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.deduction.listHrisDeductions({
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.deduction.removeHrisDeduction({
    connectionId: "<id>",
    id: "<id>",
  });
