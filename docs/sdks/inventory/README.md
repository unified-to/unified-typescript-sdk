...
async function run() {
  const result = await unifiedTo.inventory.getCommerceInventory({
    connectionId: "<id>",
    id: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.inventory.listCommerceInventories({
    connectionId: "<id>",
  });
...
async function run() {
  const result = await unifiedTo.inventory.removeCommerceInventory({
    connectionId: "<id>",
    id: "<id>",
  });
